...
/**
 * Retrieve a hexa string that can be used with btcnanod's CLI interface
 ...
 * * `disableMoreOutputThanInput`: disable checking if the transaction spends more btcnanos than the sum of the input amounts
 * @return {string}
 */
 ...
 *
 * Can receive, as output information, the output of btcnanod's `listunspent` command,
 ...
 *
 * // From a pay to public key hash output from btcnanod's listunspent
 ...
 * CheckTransaction in btcnano core.
 */
...
/**
 * Analogous to btcnanod's IsCoinBase function in transaction.h
 */
