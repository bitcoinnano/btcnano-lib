# Btcnano Crypto
The cryptographic primitives (ECDSA and HMAC) implementations in this package have been reviewed by the Btcnano engineering team. More audits and reviews are welcomed.
