# Public Key
Represents a btcnano public key and is needed to be able to receive btcnano, as is usually represented as a bitcoin [Address](address.md). See the official [Btcnano Wiki](https://en.bitcoin.it/wiki/Technical_background_of_version_1_Bitcoin_addresses).
